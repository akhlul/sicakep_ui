                    ...
                    <table class="table table-vcenter table-nowrap">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>IPDS</td>
                                <td class="text-wrap">Innas Pelatihan Inda Pemutakhiran Geospasial dan Muatan Wilkerstat</td>
                                <td>1 Kegiatan</td>
                                <td>24 Jam</td>
                                <td></td>
                                <td></td>
                            ...
                            <tr>
                                ...
                                <td>IPDS</td>
                                <td class="text-wrap">Melakukan Kompilasi Hasil Pengolahan Susenas </td>
                                <td>1 Kegiatan</td>
                                <td>2 Hari</td>
                                <td></td>
                                <td></td>
                            ...
                            <tr>
                                ...
                                <td>8 Jam</td>
                                <td>02</td>
                                <td class="text-wrap">Briefing Geotagging dan Suplemen Susenas Maret 2022</td>
                                <td class="text-center text-wrap">
                                    Sudah dinilai
                                </td>
                                <td></td>
