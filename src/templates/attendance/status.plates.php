    ...
    <div class="page-header d-print-none">
        <div class="row g-2 align-items-center">
            <div class="col">
                ...
                <h2 class="page-title">
                    Daftar Status Presensi Pegawai Per Bulan
                </h2>
            </div>
        </div>
    </div>
                ...
                <div class="row g-2">
                    <div class="col-12 col-md-auto">
                        <div class="input-group">
                            <span class="input-group-text" for="input-select-organisasi">
                                <i class="ti ti-affiliate"></i>
                            </span>
                            <select name="organisasi" class="input form-select" id="input-select-organisasi" placeholder="Pilih organisasi...">
                                <option value="1800">Provinsi Lampung</option>
                                <option value="1899">-- Seluruh Eselon 2 &amp; 3</option>
                                <hr/>
                                <option value="1801">Kab Lampung Barat</option>
                                <option value="1802">Kab Tanggamus</option>
                                <option value="1803">Kab Lampung Selatan</option>
                                <option value="1804">Kab Lampung Timur</option>
                                <option value="1805">Kab Lampung Tengah</option>
                                <option value="1806">Kab Lampung Utara</option>
                                <option value="1807">Kab Way Kanan</option>
                                <option value="1808">Kab Tulang Bawang</option>
                                ...
                                <option value="1871">Kota Bandarlampung</option>
                    ...
                    <div class="col-12 col-md-auto">
                        <div class="input-group">
                            ...
                            <select name="bulan" class="input form-select" id="input-select-bulan" placeholder="Pilih bulan...">
