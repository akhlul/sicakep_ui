    ...
    <div class="page-header d-print-none">
        <div class="row g-2 align-items-center">
            <div class="col">
                ...
                <h2 class="page-title">
                    Daftar Master Pekerjaan (Level Admin)
                </h2>
            </div>
        </div>
    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-list flex-nowrap">
                                        <button class="btn btn-sm" data-bs-toggle="modal" data-bs-target="#modal-edit-master-work">
                                            Edit
                                        </button>
                                        <button class="btn btn-sm" data-bs-toggle="modal" data-bs-target="#modal-merge-master-work" disabled>
                                            Gabung
                                        </button>
                                        <button class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#modal-delete-master-work">
                                            Hapus
                                        </button>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-list flex-nowrap">
                                        ...
                                        <button class="btn btn-sm" data-bs-toggle="modal" data-bs-target="#modal-merge-master-work">
                                            Gabung
                                        </button>
                                        <button class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#modal-delete-master-work">
                                            Hapus
...
<div class="modal modal-blur fade" id="modal-merge-master-work" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Gabung master pekerjaan</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <label class="form-label">Master Pekerjaan</label>
                <input class="form-control" disabled />
            </div>
            <div class="modal-body">
                <div class="mb-3">
                    <label class="form-label">Akan digabungkan ke master pekerjaan ini</label>
                    <input class="form-control" />
                </div>
            </div>
            <div class="modal-footer">
...
<div class="modal modal-blur fade" id="modal-delete-master-work" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <div class="modal-title">Anda sudah yakin?</div>
                <div>Jika dilanjutkan, maka master pekerjaan ini akan terhapus.</div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-link link-secondary me-auto" data-bs-dismiss="modal">Batal</button>
                <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Yes, hapus master pekerjaan ini</button>
            </div>
        </div>
    </div>
</div>
